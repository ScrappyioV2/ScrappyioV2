            ...
            <div className="bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="px-6 py-4 border-b border-slate-800">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/50 text-slate-200 placeholder:text-slate-500 transition-all"
                        />
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                    {loading ? (
                        ...
                        <div className="flex items-center justify-center h-64">
                            <div className="text-lg text-slate-500">No items found in {effectiveConfig.sourceLabel}</div>
                        </div>
                    ) : (
                        <table className="w-full">
                            <thead className="bg-slate-950 border-b border-slate-800 sticky top-0">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-center text-sm font-semibold text-slate-400">Price</th>
                                    <th className="px-4 py-3 text-center text-sm font-semibold text-slate-400">Qty</th>
                                    <th className="px-4 py-3 text-center text-sm font-semibold text-slate-400">Box / Invoice</th>
                                </tr>
                            </thead>
