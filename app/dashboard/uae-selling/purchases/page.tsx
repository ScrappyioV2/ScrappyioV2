                    ...
                    <tr key={product.id} className="hover:bg-slate-800/60 transition-colors border-b border-slate-800 group">
                      ...
                      {visibleColumns.productlink && <td className="px-3 py-2 text-center overflow-hidden" style={{ width: `${columnWidths.productlink}px` }}>
                        {(product.uae_link || product.product_link) ? (
                          <a href={(product.uae_link || product.product_link) ?? undefined} target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300 hover:underline text-xs font-medium">View</a>
