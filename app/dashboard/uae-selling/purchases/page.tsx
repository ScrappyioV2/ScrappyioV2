...
export default function PurchasesPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'uae_purchases' }, () => {
    ...
    try {
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          product_link: product.uae_link || product.product_link,
      ...
      const insertPromises = sellerTags.map(async (tag) => {
        ...
        return supabase
          ...
          .insert({
            ...
            // ========================================
            // 2. PRODUCT INFORMATION (from uae_purchases)
            // ========================================
            ...
            // ========================================
            // 3. PRICING FIELDS (from uae_purchases)
            // ========================================
            ...
            // ========================================
            // 4. FUNNEL & SELLER (from uae_purchases)
            // ========================================
            ...
            // ========================================
            // 5. PURCHASE LINKS (from uae_purchases)
            // ========================================
            inr_purchase_link: freshProduct.inr_purchase_link,    // ✅ text - FIXED!

            // ========================================
            // 6. ORIGIN (from uae_purchases)
            // ========================================
            ...
            // ========================================
            // 7. BUYING DETAILS (from uae_purchases) - USER EDITABLE
            // ========================================
            ...
            // ========================================
            // 8. TRACKING & DELIVERY (from uae_purchases) - USER EDITABLE
            // ========================================
            ...
            // ========================================
            // 9. FINANCIAL DATA (from uae_purchases)
            // ========================================
                    ...
                    <tr key={product.id} className="hover:bg-[#111111]/60 transition-colors border-b border-white/[0.1] group">
                      ...
                      {visibleColumns.productlink && <td className="px-6 py-4 text-center overflow-hidden" style={{ width: `${columnWidths.productlink}px` }}>
                        {(product.uae_link || product.product_link) ? (
                          <a href={(product.uae_link || product.product_link) ?? undefined} target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-400 hover:underline text-xs font-medium">View</a>
