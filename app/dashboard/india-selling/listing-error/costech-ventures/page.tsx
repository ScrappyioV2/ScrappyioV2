...
// RS (high_demand tab) fetches from BOTH HD + LD tables combined
...
export default function CostechVenturesListingPage() {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (tables.length === 1) {
        // Single table fetch (DP, done, pending, error, removed)
        ...
        // Multi-table fetch (RS = high_demand + low_demand)
