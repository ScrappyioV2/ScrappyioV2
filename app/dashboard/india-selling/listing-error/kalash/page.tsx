...
const ROUTE_PREFIX = 'india-selling';
const LISTING_SELLERS = [
    ...
    { tag: 'MV', name: 'Maverick', slug: 'maverick', color: 'bg-orange-600' },
    { tag: 'KL', name: 'Kalash', slug: 'kalash', color: 'bg-lime-500' },
];

export default function KalashListingErrorPage() {
  const router = useRouter();
  const currentSlug = 'kalash';
  const { user } = useAuth();
