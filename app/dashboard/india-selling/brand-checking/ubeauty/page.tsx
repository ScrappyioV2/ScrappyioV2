    ...
    try {
      if (action === 'approved') {
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'ubeauty', target: 'not_approved' }
        });
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'ubeauty', reason: reason, target: 'reject' }
        });
      }
    } catch (err: any) {
      setProducts(prev => [...prev, product]);
