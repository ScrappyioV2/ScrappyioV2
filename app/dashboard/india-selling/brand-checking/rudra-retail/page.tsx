...
export default function RudraRetailPage() {
  ...
  const [columnOrder, setColumnOrder] = useState<string[]>(() => {
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('rudraretail_column_order');
      if (saved) {
    ...
    try {
      ...
      if (action === 'approved') {
        ...
        logActivity({
          ...
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'rudra-retail', target: 'india_validation_main_file' }
        });
        ...
        logActivity({
          ...
          table_name: currentTable,
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'rudra-retail', target: targetTable }
        });
        ...
        logActivity({
          ...
          table_name: currentTable,
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'rudra-retail', reason: reason, target: targetTable }
        });
      }
    } catch (err: any) {
      setProducts(prev => [...prev, product]);
    ...
    try {
      ...
      for (const product of selectedProducts) {
        ...
        logActivity({
          ...
          asin: product.asin,
          details: { from: 'reject', to: targetTab, seller_id: SELLER_ID, seller_name: 'rudra-retail' }
        });
      }
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div className="space-y-1">
                <div className="flex items-center gap-3">
                  ...
                  <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-white">Rudra Retail Listing</h1>
                </div>
