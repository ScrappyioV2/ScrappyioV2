    ...
    try {
      if (action === 'approved') {
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'dropy-ecom', target: 'not_approved' }
        });
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'dropy-ecom', reason: reason, target: 'reject' }
        });
      }
    } catch (err: any) {
