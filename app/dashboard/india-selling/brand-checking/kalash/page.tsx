    ...
    try {
      if (action === 'approved') {
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'kalash', target: 'not_approved' }
        });
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'kalash', reason: reason, target: 'reject' }
        });
      }
    } catch (err: any) {
      setProducts(prev => [...prev, product]);
