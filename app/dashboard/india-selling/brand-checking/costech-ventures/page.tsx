    ...
    try {
      if (action === 'approved') {
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'costech-ventures', target: 'not_approved' }
        });
        ...
        logActivity({
          ...
          table_name: 'seller_products',
          asin: product.asin,
          details: { funnel: product.funnel, seller_id: SELLER_ID, seller_name: 'costech-ventures', reason: reason, target: 'reject' }
        });
      }
    } catch (err: any) {
  ...
  return (
    <>
      <div className="min-h-screen bg-[#111111] text-gray-100 font-sans selection:bg-orange-500/20">
        {/* HEADER */}
        <div className="sticky top-0 z-40 bg-[#1a1a1a] border-b border-white/[0.1] pb-4 pt-4 sm:pt-6 px-4 sm:px-6 lg:px-6">
