...
export default function InboundTable({ onCountsChange, refreshKey }: InboundTableProps) {
    ...
    const handleMoveBoxToChecking = async (boxNumber: string) => {
        ...
        try {
            ...
            // 2. Map ONLY columns that exist in dropy_box_checking
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <GenericRollbackModal
                ...
                sellerId={0}
                sellerTag=""
                sourceTableName="dropy_inbound_boxes"
                targetTableName="dropy_inbound_tracking"
            />
            <AddBoxDetailsModal
                open={boxModalOpen}
