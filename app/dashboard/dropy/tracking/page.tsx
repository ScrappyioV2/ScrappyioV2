...
export default function TrackingPage() {
    ...
    const fetchTabCounts = async () => {
        try {
            const { data, error } = await supabase.rpc('get_dropy_tracking_tab_counts');
    ...
    useEffect(() => {
        ...
        const channel = supabase
            ...
            .on("postgres_changes", { event: "*", schema: "public", table: "dropy_inbound_tracking" }, () => fetchTabCounts())
            .on("postgres_changes", { event: "*", schema: "public", table: "dropy_box_checking" }, () => fetchTabCounts())
            .subscribe();
        return () => {
            channel.unsubscribe();
        };
