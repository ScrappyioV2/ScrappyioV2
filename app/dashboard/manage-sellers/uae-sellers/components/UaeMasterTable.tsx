...
export default function UaeMasterTable({
  searchTerm,
  hiddenColumns,
  columnWidths,
  onColumnWidthChange,
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let query: any = supabase.from('uae_master_sellers').select('*');
  ...
  const handleSelectAll = async (checked: boolean) => {
    ...
    try {
      ...
      let countQuery: any = supabase.from('uae_master_sellers').select('*', { count: 'exact', head: true });
