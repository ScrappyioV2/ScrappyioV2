        ...
        <PageTransition>
            <div className="min-h-screen bg-gray-50 p-6">
                <div className="max-w-full mx-auto">
                    <div className="mb-6">
                        <h1 className="text-3xl font-bold text-gray-900">Velvet Vista - Brand Checking</h1>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex gap-3">
                                <div className="relative group">
                                    ...
                                    <div className="absolute top-full left-0 mt-2 bg-white border rounded-lg shadow-lg p-3 hidden group-hover:block z-10 w-48">
