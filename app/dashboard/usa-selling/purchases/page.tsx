                    ...
                    <tr key={product.id} className="hover:bg-[#111111]/60 transition-colors border-b border-white/[0.1] group">
                      ...
                      {visibleColumns.productlink && <td className="px-6 py-4 text-center overflow-hidden" style={{ width: `${columnWidths.productlink}px` }}>
                        {(product.usa_link || product.product_link) ? (
                          <a href={(product.usa_link || product.product_link) ?? undefined} target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:text-orange-400 hover:underline text-xs font-medium">View</a>
