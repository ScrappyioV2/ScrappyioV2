...
import { useUKDashboardStats } from "@/lib/hooks/useUKDashboardStats";
...
if (pages.includes('purchase')) return '/dashboard/uk-selling/purchases';
  ...
  const { stats, loading: statsLoading } = useUKDashboardStats({ enabled: !redirectTarget });
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 border-b border-white/[0.06] pb-6 gap-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-4xl font-bold text-white tracking-tight">UK  Overview
</h1>
            </div>
