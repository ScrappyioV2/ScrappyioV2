...
type InboundProduct = {
    ...
    // ADD THESE (match your flipkart_inbound_tracking schema)
    origin: string | null;
...
export default function AddBoxDetailsModal({
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // 3) Insert into flipkart_inbound_boxes and get ids
            ...
            if (insertedBoxes && insertedBoxes.length > 0) {
                ...
                await supabase.from("flipkart_box_history").insert(historyArchive);
            }
