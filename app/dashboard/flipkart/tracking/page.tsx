...
export default function TrackingPage() {
    ...
    const currentSellerId = useMemo(() => {
        return FLIPKART_SELLER_TAG_MAPPING[activeSeller as FlipkartSellerTag] || 1;
    }, [activeSeller]);
    ...
    useEffect(() => {
        ...
        const channel = supabase
            .channel("flipkart-tracking-inbound")
            .on("postgres_changes", { event: "*", schema: "public", table: "flipkart_inbound_tracking" }, () => fetchTabCounts())
