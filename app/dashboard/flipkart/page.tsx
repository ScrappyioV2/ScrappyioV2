...
export default function IndiaSellingPage() {
  ...
  const redirectTarget = useMemo(() => {
    ...
    if (pages.includes('validation')) return '/dashboard/flipkart/validation';
    if (pages.includes('brand-checking')) return '/dashboard/flipkart/brand-checking';
    if (pages.includes('purchase')) return '/dashboard/flipkart/purchases';
