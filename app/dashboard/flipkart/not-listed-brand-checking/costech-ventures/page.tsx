                            ...
                            <div className="flex gap-3 items-center w-full md:w-auto">
                                <div className="relative w-full md:w-72 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 bg-[#111111] border border-white/[0.1] rounded-lg text-gray-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all"
                                    />
