...
export default function CostechVenturesNotListedPage() {
    ...
    const handleDrop = (targetColumn: string) => {
        ...
        localStorage.setItem('flipkart_costechventures_notlisted_column_order', JSON.stringify(newOrder));
                            ...
                            <div className="flex gap-3 items-center w-full md:w-auto">
                                <div className="relative w-full md:w-72 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 bg-[#111111] border border-white/[0.06] rounded-lg text-gray-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 transition-all"
                                    />
                                            ...
                                            <>
                                                ...
                                                <div className="absolute top-full right-0 mt-2 bg-[#111111] border border-white/[0.06] rounded-xl shadow-xl p-2 z-20 w-48 animate-in fade-in zoom-in-95 duration-200">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full text-left px-4 py-2.5 text-sm text-gray-300 hover:bg-blue-500/10 hover:text-blue-400 rounded-lg transition-colors flex items-center gap-2"
                                                    >
