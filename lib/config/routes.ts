...
export const APP_ROUTES: AppRoute[] = [
    ...
    // --- 2. USA Marketplace ---
    {
        ...
        label: 'USA Selling',
        icon: Globe,
        permission: 'usa-selling', // Parent permission (Just to open the menu)
        subRoutes: [
            {
                path: '/dashboard/usa-selling/brand-checking',
                label: 'Brand Checking',
                permission: 'view-brand-checking', // <--- SPECIFIC PERMISSION
                icon: ShieldCheck,
                subRoutes: [
            ...
            },
            {
                ...
                label: 'Validation',
                permission: 'view-validation', // <--- SPECIFIC PERMISSION
                icon: CheckCircle2
            },
            {
                path: '/dashboard/usa-selling/listing-error',
                label: 'Listing Errors',
                permission: 'view-listing-errors', // <--- SPECIFIC PERMISSION
                icon: XCircle,
                subRoutes: [
            ...
            },
            {
                ...
                label: 'Purchases',
                permission: 'view-purchases', // <--- SPECIFIC PERMISSION
                icon: ShoppingBag
            },
            {
            ...
            },
            {
                ...
                label: 'Reorder',
                permission: 'view-reorder', // <--- SPECIFIC PERMISSION
                icon: RotateCcw
            },
            {
    ...
    // --- 3. India Marketplace ---
    {
        ...
        subRoutes: [
            { path: '/dashboard/india-selling/validation', label: 'Validation', permission: 'india-selling' },
            { path: '/dashboard/india-selling/purchases', label: 'Purchases', permission: 'india-selling' }
        ]
    },
